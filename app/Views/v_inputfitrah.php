    ...
    <form action="<?php echo base_url('tampil/saveData') ?>" method="post">
        <div class="box-body">
            <div class="form-group">
                ...
                <input type="Nik" class="form-control" id="Nik" name="Nik" placeholder="Masukkan Nik Anda">
            </div>
            <div class="form-group">
                <label>Pilihan</label>
                <select class="form-control select2" style="width: 100%;" id="Pilihan" name="Pilihan">
            ...
            <div class="form-group">
              ...
              <input type="Nominal Transaksi" class="form-control" id="Nominal" name="Nominal" placeholder="Min Transaksi Rp40.000">
            </div>
            <div class="form-group">
